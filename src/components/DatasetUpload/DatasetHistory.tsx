      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center space-x-4">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white animate-fade-in">Dataset Analysis History</h1>
            {history.length > 0 && (
              <button
                onClick={clearHistory}
                className="flex items-center space-x-2 px-4 py-2 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-all duration-300 transform hover:scale-105"
              >
        ...
        {history.length === 0 ? (
          <div className="text-center py-16 animate-fade-in">
            <BarChart3 className="w-16 h-16 text-gray-400 dark:text-gray-600 mx-auto mb-4 animate-pulse" />
          ...
          <div className="space-y-6">
            {history.map((analysis, index) => (
              <div key={analysis.id} className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 transition-all duration-300 hover:shadow-xl transform hover:-translate-y-1 animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
                <div className="flex items-start justify-between mb-4">
                  ...
                  <button className="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-all duration-300 transform hover:scale-110">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="lg:col-span-1">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="text-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg hover:scale-105 transition-transform">
                      ...
                      <div className="text-center p-3 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg hover:scale-105 transition-transform">
                      ...
                      <div className="text-center p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg hover:scale-105 transition-transform">
                      ...
                      <div className="text-center p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg hover:scale-105 transition-transform">
                  ...
                  <div className="lg:col-span-2">
                    ...
                    <div className="space-y-3">
                      {analysis.recommendations.map((rec, recIndex) => (
                        <div key={recIndex} className="border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:border-blue-300 dark:hover:border-blue-500 transition-all duration-300 animate-fade-in" style={{ animationDelay: `${(index * 0.1) + (recIndex * 0.05)}s` }}>
                          ...
                          <div className="mt-2 flex items-center justify-between">
                            <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1.5 mr-3">
                              <div 
                                className="bg-blue-600 dark:bg-blue-400 h-1.5 rounded-full transition-all duration-1000"
